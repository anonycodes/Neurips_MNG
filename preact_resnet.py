...
class PreActBottleneck(MetaModule):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.blockConv2 = nn.Sequential(
               ...
               MetaBatchNorm2d(planes))
        self.blockConv3 = MetaConv2d(planes, self.expansion * planes, kernel_size=1, stride=stride, bias=False)
...
class PreActResNet(MetaModule):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.layer1 = nn.Sequential(PreActBlock(self.in_planes, 64), PreActBlock(self.in_planes, 64))
        self.layer2 = nn.Sequential(PreActBlock(64, 128, 2), PreActBlock(128, 128))
        self.layer3 = nn.Sequential(PreActBlock(128, 256, 2), PreActBlock(256, 256))
        self.layer4 = nn.Sequential(PreActBlock(256, 512, 2), PreActBlock(512, 512))
